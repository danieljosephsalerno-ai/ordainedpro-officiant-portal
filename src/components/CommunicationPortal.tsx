...
Mr. Script - Your Personal Wedding Script Creator`;
  ...
  const handleChatSubmit = () => {
    ...
    // Check for script generation requests
    if (
      lowerInput.includes("yes") ||
      lowerInput.includes("generate script") ||
      lowerInput.includes("create script")
    ) {
      setChatInput("");
    ...
    if (
      hasGeneratedScript &&
      /change|modify|update|add|remove|edit|make it|can you|please/i.test(
        lowerInput
      )
    ) {
      setChatInput("");
    ...
    // Save answer to current guided question
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        const scriptOfferMessage: ChatMessage = {
          ...
          type: "ai",
          content:
            "Perfect! I have everything I need. Would you like me to generate your complete ceremony script now? Just say 'yes' or 'generate script' and I'll create your personalized wedding ceremony!",
          timestamp: new Date(),
        };
...
I've created a beautiful ${userResponses["ceremony-type"] || selectedCeremonyStyle
          } ceremony script for ${editCoupleInfo.brideName} & ${editCoupleInfo.groomName
          }.
...
${(userResponses["special-elements"] || selectedUnityCeremony) !== "None"
            ? `✅ ${userResponses["special-elements"] || selectedUnityCeremony
            } unity ceremony`
            : ""
          }
...
pastor.michael@ordainedpro.com`,
  ...
  const handleContractUploaded = (
    contractData: Omit<Contract, "id" | "createdDate">
  ) => {
                        ...
                        onClick={() => {
                          if (confirm("Are you sure you want to logout?")) {
                            ...
                            window.location.href =
                              process.env.NEXT_PUBLIC_WP_LOGOUT_URL ||
                      ...
                      <div className="mb-6">
                        ...
                        {currentQuestionIndex === GUIDED_QUESTIONS.length && (
                          <p className="text-xs text-green-700 mt-2 font-medium flex items-center">
                            ...
                            All questions completed! You can now refine your
                            script.
                          </p>
                        )}
                      </div>
                        ...
                        <div className="border-t border-gray-200 p-3">
                          ...
                          <div className="mt-4 pt-4 border-t-2 border-gray-200">
                              ...
                              <div className="relative">
                                <Button
                                  ...
                                  title={
                                    currentQuestionIndex <
                                      GUIDED_QUESTIONS.length
                                      ? "Answer all guided questions first"
                                      : "Refine your script"
                                  }
                                >
                            ...
                            <p className="text-xs text-gray-500 text-center mt-2">
                              {currentQuestionIndex < GUIDED_QUESTIONS.length
                                ? `Answer ${GUIDED_QUESTIONS.length -
                                currentQuestionIndex
                                } more question(s) to unlock Refine Script`
                                : hasGeneratedScript
